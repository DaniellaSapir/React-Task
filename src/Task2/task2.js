...
const genNumbers= (props) => {
    ...
    return (
        null
        // <div onClick={genNumbers}> Array of numbers : 
        //     // return React.createElement('div', null, React.createElement('h1', {className: 'App'} ,'Hi this is Daniella'));  //h1 rendered with the styles for class App
